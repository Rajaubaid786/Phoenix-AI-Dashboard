...
const RevenueChart = ({ clients = [] }) => {
  ...
  const data = [
    ...
    { month: "May", revenue: currentMonthRevenue },
  ];
  ...
  return (
    <div className="bg-card border border-white/5 rounded-2xl p-6 h-full flex flex-col">
      ...
      {/* 🔥 The Fix: No CSS height dependencies. Direct inline style aur prop use kiya hai */}
      <div style={{ width: '100%', height: 300 }} className="mt-4">
        {/* height={300} direct prop diya hai taake calculation ka masla hi na ho */}
